...
{
    private readonly List<ImportedFrame> children;
    ...
    public ImportedFrame(int childrenCount = 0) => children = new List<ImportedFrame>(childrenCount);
    ...
    public void Remove(ImportedFrame frame) => children.Remove(frame);
