        ...
        for (var s = 0; s < m_Streams.Length; s++)
        {
            ...
            for (var i = 0; i < 6; i++)
            {
                if (channelMask.Get(i))
                {
                    ...
                    offset += (byte)(m_Channel.dimension *
                                     MeshHelper.GetFormatSize(MeshHelper.ToVertexFormat(m_Channel.format, version)));
                }
            }
        }
...
public sealed class Mesh : NamedObject
{
    ...
    private readonly CompressedMesh m_CompressedMesh;
    ...
    private readonly StreamingInfo m_StreamData;
    public SubMesh[] m_SubMeshes;
    public float[] m_Tangents;
    private readonly bool m_Use16BitIndices = true;
    public float[] m_UV0;
    public float[] m_UV1;
    public float[] m_UV2;
    public float[] m_UV3;
    ...
    private readonly VertexData m_VertexData;
    ...
    public Mesh(ObjectReader reader) : base(reader)
    {
        ...
        if (version[0] > 2 || version[0] == 2 && version[1] >= 6) //2.6.0 and up
        {
            ...
            if (version[0] > 2017 || version[0] == 2017 && version[1] >= 4 || //2017.4
                version[0] == 2017 && version[1] == 3 && version[2] == 1 &&
                buildType.IsPatch || //fixed after 2017.3.1px
        ...
        {
            var m_CookingOptions = reader.ReadInt32();
        }
    ...
    private void ReadVertexData()
    {
        ...
        for (var chn = 0; chn < m_VertexData.m_Channels.Length; chn++)
        {
            ...
            if (m_Channel.dimension > 0)
            {
                ...
                {
                    if (version[0] < 2018 && chn == 2 &&
                        m_Channel.format == 2) //kShaderChannelColor && kChannelFormatColor
                        m_Channel.dimension = 4;
